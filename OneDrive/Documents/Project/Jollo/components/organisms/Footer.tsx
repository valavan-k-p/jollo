...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="relative bg-[#111111] overflow-hidden">
      ...
      {/* Big CTA section */}
      <div className="relative z-10 min-h-[85vh] flex items-center border-b border-white/[0.06]">
        <div
        ...
        <div className="container-jollo relative z-10 w-full">
          <div data-footer-reveal className="flex flex-col gap-10 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-5 pt-2">
              <Link href={site.primaryCta.href} className="jbtn jbtn--outline jbtn--lg">
              ...
              <a href={`mailto:${site.email}`} className="jbtn jbtn--ghost jbtn--lg">
                {site.email}
              </a>
            </div>
          </div>
      ...
      <div className="container-jollo relative z-10" style={{ padding: "clamp(3rem, 6vw, 6rem) clamp(1rem, 4vw, 4rem)" }}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-10">
          ...
          <div data-footer-reveal className="lg:col-span-4 flex flex-col gap-5">
            <Link href="/" className="inline-block group">
              <Image
                ...
                width={480}
                height={120}
                className="h-32 w-auto object-contain brightness-100 group-hover:brightness-125 transition-all duration-300"
              />
            </Link>
          ...
          <div data-footer-reveal className="lg:col-span-3">
            <h3 className="type-ui--label text-white/35 mb-7">
              Services
            </h3>
            <ul className="flex flex-col gap-3.5">
              {services.map((s) => (
                <li key={s.href}>
                  <Link
                    href={s.href}
                    className="group/link font-body text-sm text-white/50 hover:text-white transition-colors duration-300 flex items-center gap-3"
                  >
          ...
          <div data-footer-reveal className="lg:col-span-3">
            ...
            <a
              ...
              className="font-body text-sm text-white/50 hover:text-[#e9e612] transition-colors duration-300"
            >
              {site.email}
            </a>
